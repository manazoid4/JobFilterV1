...
export function registerMaterialPricesRoute(app: Express) {
  app.get('/api/material-prices', (req: Request, res: Response) => {
    ...
    res.json({
      ...
      postcode,
      checkedAt: CHECKED_AT,
      disclaimer: 'Static reference prices last manually verified on 22 May 2026. Confirm current prices with supplier before purchase — live scraping not yet active.',
