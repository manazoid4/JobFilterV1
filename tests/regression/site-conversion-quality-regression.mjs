...
for (const payload of [
  ...
  { name: 'Regression Test', trade: 'Electrician', contact: '', source: 'regression-test-missing-contact' },
  { name: 'Regression Test', trade: 'Roofer', contact: `regression-test-${Date.now()}@example.com`, source: 'regression-test-valid' },
]) {
