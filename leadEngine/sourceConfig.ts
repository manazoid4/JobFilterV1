...
export const SOURCE_REGISTRY: SourceConfigEntry[] = [
  ...
  { key: 'Searchland',              label: 'Searchland',                endpoint: 'https://searchland.co.uk/',                                                signalClass: 'planning',    readiness: 'partner-required', scoreBonus: 8,  defaultEnabled: false, apiKeyEnv: 'SEARCHLAND_API_KEY' },
