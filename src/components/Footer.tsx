      ...
      <div className="mx-auto max-w-7xl px-4 py-12">
        ...
        <div className="mb-10 grid gap-4 md:grid-cols-[1fr_auto] md:items-center">
          <div>
            ...
            <p className="headline mt-1 text-3xl sm:text-4xl">Start filtering today. Free scan. No signup.</p>
          </div>
        ...
        <div className="grid gap-8 sm:grid-cols-2 lg:grid-cols-4">
          {/* Product */}
          <div>
            <p className="micro-label text-[var(--yellow)] mb-3">PRODUCT</p>
            <div className="grid gap-2 text-sm font-black uppercase text-white/70">
          ...
          {/* Tools */}
          <div>
            <p className="micro-label text-[var(--yellow)] mb-3">TOOLS</p>
            <div className="grid gap-2 text-sm font-black uppercase text-white/70">
          ...
          {/* Company */}
          <div>
            <p className="micro-label text-[var(--yellow)] mb-3">COMPANY</p>
            <div className="grid gap-2 text-sm font-black uppercase text-white/70">
          ...
          {/* Trust */}
          <div>
            <p className="micro-label text-[var(--yellow)] mb-3">BUILT IN BIRMINGHAM</p>
        ...
        <div className="mt-10 border-t border-white/10 pt-6 flex flex-col sm:flex-row justify-between gap-3">
          <p className="text-sm font-black uppercase text-white/50">© 2026 JobFilter. All rights reserved.</p>
          <p className="text-sm font-black uppercase text-white/50">Protect your time.</p>
        </div>
      </div>
    </footer>
  );
