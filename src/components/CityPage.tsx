...
export const CITIES: CityData[] = [
  {
    ...
    heroH1: 'Find building work in Birmingham before the chase gets crowded.',
    heroSub: 'JobFilter watches local construction signals across Birmingham and the West Midlands — and sends the jobs worth chasing straight to your phone. Built here. No lead auction. No per-lead fees.',
    statsNote: 'Birmingham generates more construction movement per week than any UK city outside London. The Big City Plan and HS2 fallout mean thousands of trades are competing for the same jobs. JobFilter ranks the ones worth chasing first.',
    localAngle: 'Built in Birmingham. Not London.',
    localAngleBody: 'We know how this city works. From Erdington to Selly Oak, from Solihull to Walsall — the jobs are here. The problem is finding them before 8 other blokes quote. JobFilter was built in Birmingham for Birmingham trades. We watch verified job signals across the B postcodes — and score them before they reach you.',
  ...
  },
  {
    ...
    heroH1: 'Find construction leads in London before the chase gets crowded.',
    heroSub: 'London moves fast. JobFilter watches verified job signals across every London postcode — and scores the leads worth chasing. No lead auction. No per-lead fees. £39/month.',
    statsNote: 'London has more construction movement than any UK city by a massive margin. But 45,000+ trades are fighting for the same work. The ones who win are the ones who move while the timing is fresh.',
    localAngle: 'London moves fast. The first quote wins 70% of jobs.',
    localAngleBody: 'Every borough in London has different rules, different paperwork, different timelines. JobFilter turns that noise into scored job signals. When something scores GOLD, it hits your WhatsApp while the timing is still fresh. Not batched. Not delayed.',
  ...
  },
  {
    ...
    heroH1: 'Construction leads in Manchester — scored signals, not dead enquiries.',
    heroSub: 'Manchester is the fastest-growing construction market in the North. £8 billion in active projects. JobFilter watches verified job signals across Greater Manchester — and sends GOLD leads to your WhatsApp. No lead auction. No per-lead fees.',
    ...
    localAngleBody: 'Manchester has serious construction movement every week. The city is growing — new builds, conversions, retrofit work, commercial jobs. But most trades still rely on Checkatrade and word of mouth. JobFilter watches every M postcode for verified job signals. When a job scores GOLD, you know which one to chase first.',
  ...
  },
  {
    ...
    heroH1: 'Bristol construction leads — find retrofit, extension and public work.',
    heroSub: 'Bristol has some of the strongest upgrade pressure in the UK. JobFilter watches verified job signals across the BS postcodes — and sends the best leads to your phone. No lead auction. No per-lead fees.',
    statsNote: 'Bristol leads the UK on green building standards. Local targets mean massive demand for retrofit, insulation, and heat pump work.',
    localAngle: 'Bristol is a retrofit-heavy market. The demand is visible.',
    localAngleBody: 'Bristol has serious upgrade pressure. That means thousands of properties need insulation, heat pumps, solar panels, and retrofit work before deadlines bite. JobFilter flags the strongest job signals across the South West. The demand is visible. The question is who moves first.',
  ...
  },
  {
    ...
    localAngleBody: 'Leeds is the economic engine of the North. South Bank regeneration, South Leeds Industrial Strategy, the Aire Valley enterprise zone — billions in construction work. But 8,000+ builders across West Yorkshire are competing for it. JobFilter watches verified job signals across the LS postcodes. When a job scores GOLD, it hits your WhatsApp. Not email. Not a dashboard. WhatsApp.',
...
export function CityPage({ city }: CityPageProps) {
  ...
  useEffect(() => {
    document.title = `Construction Leads in ${city.name} — Scored Job Signals | JobFilter`;
    const metaDesc = document.querySelector('meta[name="description"]');
    if (metaDesc) {
      metaDesc.setAttribute(
        'content',
        `Find ${city.name.toLowerCase()} construction leads from verified job signals. ${city.planningAppsPerWeek}+ local signals per week. Scan free — no card required.`
      );
    }
  }, [city]);
        ...
        <div className="page-shell section-pad">
          ...
          <div className="mt-8 grid gap-4 md:grid-cols-3">
            <div className="jf-box bg-[var(--bg-main)] p-6">
              <p className="micro-label text-[var(--muted)]">FRESH JOB SIGNALS</p>
              <p className="headline mt-2 text-5xl text-[var(--navy)]">{city.planningAppsPerWeek}/wk</p>
              <p className="mt-2 font-black text-[var(--muted)]">New extensions, conversions, and builds flagged every week across {city.name}</p>
            </div>
            <div className="jf-box bg-[var(--bg-main)] p-6">
              ...
              <p className="mt-2 font-black text-[var(--muted)]">Properties under pressure to upgrade before deadlines bite</p>
            </div>
            <div className="jf-box bg-[var(--bg-main)] p-6">
              <p className="micro-label text-[var(--muted)]">PUBLIC WORK SIGNALS</p>
              <p className="headline mt-2 text-5xl text-[var(--navy)]">{city.councilContractsActive}</p>
              <p className="mt-2 font-black text-[var(--muted)]">Public-sector work in {city.region} that local trades can act on</p>
            </div>
          </div>
          ...
          <div className="mt-8 grid gap-4 md:grid-cols-2">
            <div className="jf-box bg-white p-6">
              ...
              <ul className="mt-4 grid gap-3 font-black text-[var(--muted)]">
                ...
                <li>✗ Manual searching — hours of digging</li>
              </ul>
            </div>
            <div className="jf-box bg-[var(--ink)] p-6 text-white">
              ...
              <ul className="mt-4 grid gap-3 font-black text-white/85">
                <li>✓ Every scan is private — your results stay in your account</li>
                <li>✓ Verified job signals — scored before you chase</li>
        ...
        <div className="page-shell section-pad">
          ...
          <div className="mt-8 grid gap-6 md:grid-cols-3">
            ...
            <div className="jf-box bg-[var(--bg-main)] p-7">
              ...
              <p className="mt-2 text-sm font-black text-[var(--muted)]">
                When a job scores 80+, it fires to your phone quickly. Not batched. Not delayed. While the timing is still fresh.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="bg-white">
        <div className="page-shell section-pad">
          ...
          <p className="mt-3 max-w-xl text-lg font-black text-[var(--muted)]">
            JobFilter scans verified job signals in every major UK city.
          </p>
            ...
            {otherCities.map((c) => (
              ...
              >
                ...
                <div className="mt-3 grid gap-1 text-sm font-black text-[var(--muted)]">
                  <p>{c.planningAppsPerWeek} local signals/week</p>
                  <p>{c.epcFGProperties.toLocaleString()} retrofit properties</p>
                  <p>{c.councilContractsActive} public work signals</p>
                </div>
