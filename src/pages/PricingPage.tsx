...
const objections = [
  ...
  ['How is this different from Checkatrade, BuildAlert or Bark?', 'Checkatrade and Bark sell shared homeowner enquiries — the same lead goes to 4–8 trades and you compete on price. BuildAlert surfaces planning data but does not score fit or show the response route. JobFilter qualifies public-sector and commercial notices against your firm specifically: buyer, deadline, missing evidence, and whether to bid directly or via a subcontract route.'],
];
  ...
  return (
    <main className="page-shell grid gap-6 py-8 pb-16 text-[var(--ink)]">
      ...
      <section className="ops-panel bg-[var(--ink)] p-7 text-white">
        ...
        <p className="mt-1 text-sm font-black text-white/60">Scan first. Pay only if the coverage fits your firm. Current results can be sparse or empty.</p>
      ...
      <section className="ops-panel bg-[var(--yellow)] p-7 text-[var(--ink)]">
        ...
        <p className="mt-1 text-sm font-black text-[var(--ink)]/60">Run a free scan first. If the coverage fits, activation takes 2 minutes.</p>
      </section>
    </main>
  );
}
