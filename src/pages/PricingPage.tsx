    ...
    <main className="page-shell grid gap-6 py-8 pb-16 text-[var(--ink)]">
      ...
      <section className="grid gap-4 lg:grid-cols-2">
        ...
        <PlanCard
          title="Pilot"
          price="£39/mo"
          priceNote="No contract. Cancel any time."
          body="Firm-aware qualification for public works. BID, WATCH, SUBCONTRACT or SKIP — with buyer contact, evidence, and the official response route for each notice."
          items={planBullets}
          featured
