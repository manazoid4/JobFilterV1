...
const objections = [
  ...
  ['Why not just use Checkatrade, Bark or MyBuilder?', 'Checkatrade, Bark, and MyBuilder connect trades with homeowners — domestic leads, shared with multiple trades. JobFilter is for firms going after public procurement: government, councils, housing associations. Different buyers, higher contract values, longer relationships.'],
  ...
  return (
    <main className="page-shell grid gap-6 py-8 pb-16 text-[var(--ink)]">
      ...
      <section className="ops-panel bg-[var(--ink)] p-7 text-white">
        <p className="micro-label text-[var(--yellow)]">COVERAGE-FIRST PILOT — CHECK BEFORE YOU PAY</p>
        ...
        <p className="mt-5 max-w-2xl text-xl font-bold text-white/85">
          JobFilter compares current Find a Tender notices against your trade, delivery region and contract range — then gives you a clear BID, WATCH, SUBCONTRACT or SKIP. No guesswork. No wasted afternoons on the wrong tender.
        </p>
