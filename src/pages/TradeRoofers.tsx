...
const data: TradePageData = {
  ...
  signals: [
    ...
    ['EPC data', 'Properties with poor EPC ratings often need roof insulation, flat roof replacements, or full re-roofs as part of retrofit upgrades. EPC data shows which properties are likely candidates.'],
  ...
  howItWorks: [
    ['01', 'Enter your postcode', 'Tell us where you roof. We scan planning portals, EPC registers, and council contracts within your working radius.'],
  ...
  tradeLeadExample: {
    ...
    rows: [
      ...
      ['Official Source', 'Hackney Council Planning — 93% confidence'],
