...
const GENERIC_TRADE_LABELS: Partial<Record<string, Set<string>>> = {
  ...
  building: new Set(['BUILDING WORK — YOUR TRADE', 'CONSTRUCTION — YOUR TRADE', 'STRUCTURAL — YOUR TRADE', 'REFURBISHMENT — YOUR TRADE', 'RENOVATION — YOUR TRADE', 'GARAGE — YOUR TRADE', 'CONVERSION — YOUR TRADE']),
