...
const TRADE_KEYWORD_LABELS: Record<string, Record<string, string>> = {
  electrical: {
    'ev charger': 'EV CHARGER WORK', 'electric vehicle': 'EV CHARGER WORK',
    'rewire': 'REWIRING WORK', 'rewiring': 'REWIRING WORK',
    'consumer unit': 'CONSUMER UNIT WORK', 'fuse board': 'FUSE BOARD WORK',
    'eicr': 'EICR CERT', 'pat test': 'PAT TESTING',
    'fire alarm': 'FIRE ALARM WORK', 'rcd': 'RCD WORK',
    'solar pv': 'SOLAR PV WORK', 'battery storage': 'BATTERY STORAGE',
    'solar': 'SOLAR WORK', 'lighting': 'LIGHTING WORK',
    'smart home': 'SMART HOME WORK', 'cctv': 'CCTV WORK',
  ...
  plumbing: {
    ...
    'bathroom': 'BATHROOM WORK', 'wet room': 'WET ROOM WORK',
    ...
    'pressurised': 'PRESSURISED SYSTEM', 'shower': 'SHOWER WORK',
  ...
  hvac: {
    'heat pump': 'HEAT PUMP WORK', 'air source': 'AIR SOURCE HP',
    'ashp': 'ASHP WORK', 'gshp': 'GSHP WORK',
