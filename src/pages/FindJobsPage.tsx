  ...
  return (
    <main className="page-shell grid gap-5 py-8 pb-24 md:pb-8">
      ...
      <section className="jf-box bg-white p-7">
        ...
        {/* Form — postcode + radius, trade is selected below via quick-scan buttons */}
        <form onSubmit={submit} aria-busy={loading || fillWeekLoading} className="mt-5 grid gap-3 grid-cols-1 sm:grid-cols-[1fr_1fr_auto]">
        ...
        {scanHistory.length > 0 && (
          <div className="mt-4 flex flex-wrap items-center gap-2">
            <span className="micro-label text-[var(--muted)] text-[10px]">REPEAT A SCAN:</span>
        ...
        {/* Trade quick-scan buttons — select your trade and scan in one tap */}
        <div className="mt-4">
          <p className="micro-label text-[var(--muted)]">SELECT YOUR TRADE — SCANS INSTANTLY</p>
