    ...
    <main className="page-shell grid gap-5 py-8 pb-24 md:pb-8">
          ...
          <div className={`mt-3 flex items-center gap-3 border-2 px-4 py-2.5 ${weeklyScansRemaining === 0 ? 'border-[var(--orange)] bg-[var(--orange)]/10' : weeklyScansRemaining === 1 ? 'border-[var(--orange)] bg-[var(--orange)]/5' : 'border-[var(--green)] bg-[var(--green)]/10'}`}>
            ...
            <p className="text-sm font-black text-[var(--ink)]">
              {weeklyScansRemaining > 0
                ...
                : 'Buyer details locked — scan is still free. Upgrade to see who to call.'}
            </p>
            {weeklyScansRemaining === 0 ? (
      ...
      {!hasScanned && !loading && !fillWeekLoading && (
        <section className="jf-box bg-[var(--navy)] p-6 text-center text-white" style={{ backgroundImage: 'url("data:image/svg+xml,%3Csvg width=\'60\' height=\'60\' xmlns=\'http://www.w3.org/2000/svg\'%3E%3Ccircle cx=\'30\' cy=\'30\' r=\'1.5\' fill=\'%23E3B72A\' opacity=\'0.2\'/%3E%3C/svg%3E")' }}>
          ...
          <p className="micro-label text-[var(--yellow)]">CHECKATRADE CHARGES £80/MO. BARK SELLS THE SAME LEAD TO 5 TRADES.</p>
          <h2 className="headline mt-3 text-3xl leading-none sm:text-5xl">SCAN YOUR PATCH. FIND JOBS WORTH PRICING.</h2>
          <p className="mt-3 font-black text-white/70">
            Verified signals from official sources — public contract notices scored for your trade and distance. Coverage varies by area and timing. 10 seconds. No credit card required.
          </p>
          <div className="mt-2 mb-4 flex flex-wrap justify-center gap-3 text-xs font-black text-[var(--yellow)]/80">
            <span>No shared auction</span>
            <span>·</span>
            <span>No five-trade blast</span>
            <span>·</span>
            <span>Gold leads scored for your trade and patch</span>
          </div>
