...
const data: TradePageData = {
  ...
  painPoints: [
    ...
    ['Office-to-residential conversions are huge HVAC contracts', 'Permitted development and full planning approvals for office-to-resi conversions require complete HVAC redesign. These are £45k-£120k contracts — but they\'re sitting in planning portals, not on any M&E tender site.'],
