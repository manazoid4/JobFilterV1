...
const comparison = [
  ...
  { feature: 'Monthly fee', checkatrade: '£50-£90/mo per category', jobfilter: '£29/mo — all trades, all signals' },
    ...
    <main className="pb-8">
          ...
          <div className="mt-8 grid gap-6 md:grid-cols-2">
            ...
            <div className="jf-box bg-[var(--navy)] p-6 text-white">
              ...
              <ul className="mt-4 grid gap-3 font-black text-white/85">
                <li>£29/month — all trades, all signals</li>
            ...
            <table className="w-full min-w-[600px] border-collapse text-sm font-black">
              <thead>
                <tr className="bg-[var(--navy)] text-white">
                  ...
                  <th className="px-4 py-3 text-left text-white/60">Checkatrade</th>
      ...
      <section className="bg-[var(--yellow)] border-y-4 border-[var(--line)]">
        <div className="page-shell section-pad">
          ...
          <h2 className="headline mt-3 max-w-4xl text-4xl leading-[0.9] sm:text-6xl md:text-7xl">£29/MO ALL-IN. VS £50-£90/MO + PER-LEAD FEES.</h2>
          <p className="mt-5 max-w-2xl text-xl font-black text-[var(--ink)]/75">
            Checkatrade charges £50-£90/month per category, then charges per-lead on top. Trades report £200+/month before any work arrives. JobFilter is £29/month flat. Unlimited scans. No per-lead fees. No category restrictions.
          </p>
