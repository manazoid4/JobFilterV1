      ...
      <section className="jf-box bg-white p-6">
        ...
        <div className="mt-5 grid gap-4 md:grid-cols-3">
          {[
            ...
            ['Your patch. Your timing.', 'Scan your patch and Gold leads appear in seconds. One tap sends to WhatsApp. No five-trade blast, no shared auction. Pilot patches are limited — one trade per area, qualification checked.'],
          ].map(([title, body]) => (
