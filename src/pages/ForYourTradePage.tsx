...
const trades = [
  { id: 'electrical', label: 'Electrical', fearHook: 'On Checkatrade, a rewire lead goes to 4 electricians at once. The one who calls first gets it. You need to call before Checkatrade even knows the job exists.', signals: 'Rewires, EV charger installs, consumer unit upgrades, landlord EICR compliance — scored before Checkatrade or Bark list them', value: '£800 - £50k', example: { title: 'Consumer unit + rewire - rental compliance', area: 'B14 / West Midlands', value: '£4,500', urgency: 'Tenant move-in deadline', source: 'Verified official signals' } },
  ...
  { id: 'solar', label: 'Solar PV', fearHook: 'Detached homes with high energy bills are the best solar leads. Bark lists them after the homeowner has already Googled 3 installers. JobFilter flags energy signals days before any directory.', signals: 'Detached homes with high energy demand, new-build solar obligations, low-carbon retrofit signals — tracked 3–5 days before Bark or MyBuilder lists them', value: '£6k - £25k', example: { title: '4kW solar array — detached home', area: 'SE19 / London', value: '£9,800', urgency: 'Spring install window open', source: 'Verified energy signals' } },
  { id: 'ev-charger', label: 'EV Charger', fearHook: 'Commercial fleet charger tenders and garage-permit installs go fast. Checkatrade and BuildAlert see them late. JobFilter flags planning conditions with EV obligations the day they are published.', signals: 'Garage planning permits with EV conditions, commercial fleet charger tenders, residential pod installs — flagged before Checkatrade or BuildAlert see them', value: '£800 - £15k', example: { title: 'Commercial EV charger pod — 4 bays', area: 'SE1 / London', value: '£4,200', urgency: 'Fleet rollout deadline', source: 'Verified planning condition' } },
  { id: 'heat-pumps', label: 'Heat Pumps', fearHook: 'F/G-rated properties must upgrade by deadline. Bark and Checkatrade list them after the homeowner has three quotes. JobFilter tracks energy ratings — you call before they start shopping.', signals: 'F/G-rated properties, Boiler Upgrade Scheme signals, social housing decarbonisation tenders — detected before Bark or Checkatrade lists them', value: '£8k - £18k', example: { title: 'Air source heat pump — F-rated terrace', area: 'NG1 / Nottingham', value: '£12,500', urgency: 'BUS grant window open', source: 'Verified energy signals' } },
  { id: 'decorating', label: 'Decorating', fearHook: 'Tenancy turnarounds and commercial redecoration contracts go to whoever responds first. Bark floods the same lead to 5 decorators. JobFilter surfaces planning-approved renovations before any directory lists them.', signals: 'Planning-approved renovations, tenancy turnaround contracts, commercial premises redecoration tenders — sourced before Bark or MyBuilder lists them', value: '£500 - £20k', example: { title: 'Commercial premises redecoration', area: 'M1 / Manchester', value: '£8,500', urgency: 'Pre-opening deadline', source: 'Official tender record' } },
  { id: 'scaffolding', label: 'Scaffolding', fearHook: 'Every planning-approved extension needs scaffold. The main contractor calls whoever they worked with last, or the first scaffolder who made contact. JobFilter flags the approval before any scaffolder gets a call.', signals: 'Planning-approved extensions, street occupation permits, large commercial refurb contracts — leads land days before scaffold hire companies get the call', value: '£500 - £25k', example: { title: 'Extension scaffold — planning approved', area: 'E5 / London', value: '£3,200', urgency: 'Build start confirmed', source: 'Verified planning approval' } },
  ...
  { id: 'data-cabling', label: 'Data Cabling', fearHook: 'Office fit-outs and school cabling contracts are awarded before any directory hears about them. You need to be talking to the main contractor before tender closes. JobFilter flags them 3–5 days earlier.', signals: 'Commercial office fit-out tenders, school and NHS structured cabling contracts, business park signups — scanned 3–5 days before Checkatrade or MyBuilder sees them', value: '£2k - £30k', example: { title: 'Cat6A structured cabling — office fit-out', area: 'EC2 / London', value: '£18,500', urgency: 'Tenant move-in date', source: 'Verified tender record' } },
