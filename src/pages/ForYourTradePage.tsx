...
const trades = [
  ...
  { id: 'scaffolding', label: 'Scaffolding', fearHook: 'Every large project needs scaffold, and the main contractor calls whoever they already know. Public procurement tenders for commercial refurbs, social housing works, and large construction frameworks are published before the main contractor starts hiring trades. JobFilter surfaces these tenders before any directory lists the same job.', signals: 'Planning-approved extensions, street occupation permits, large commercial refurb contracts — leads land days before scaffold hire companies get the call', value: '£500 - £25k', example: { title: 'Extension scaffold — planning approved', area: 'E5 / London', value: '£3,200', urgency: 'Build start confirmed', source: 'Verified planning approval' } },
  { id: 'fire-safety', label: 'Fire Safety', fearHook: 'Commercial fire alarm tenders close in days. Checkatrade and directories see them late or not at all. JobFilter surfaces public fire safety and compliance procurement contracts before any directory lists the same job.', signals: 'Fire alarm upgrades, suppression system tenders, fire door surveys, commercial building compliance contracts — flagged before Checkatrade or any directory lists the same job', value: '£1k - £80k', example: { title: 'Fire alarm system upgrade — commercial premises', area: 'E1 / London', value: '£12,000', urgency: 'Building regulations compliance deadline', source: 'Official tender record' } },
  ...
  { id: 'cctv', label: 'CCTV / Security', fearHook: 'Security system tenders for retail, schools, and commercial premises are awarded before most firms hear about them. Bark and MyBuilder see these late. JobFilter surfaces public CCTV and security procurement contracts before any directory lists the same job.', signals: 'School and NHS surveillance tenders, retail and commercial security contracts, public building compliance tenders — sourced before any install firm on Bark or MyBuilder gets a call', value: '£1.5k - £40k', example: { title: '24-camera CCTV system — retail park', area: 'B1 / West Midlands', value: '£22,000', urgency: 'Pre-opening deadline', source: 'Official planning condition' } },
