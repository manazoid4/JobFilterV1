...
const trades = [
  ...
  { id: 'solar', label: 'Solar PV', signals: 'Detached homes with high energy demand, new-build solar obligations, low-carbon retrofit signals — tracked 3–5 days before any installer on MyBuilder sees them', value: '£6k - £25k', example: { title: '4kW solar array — detached home', area: 'SE19 / London', value: '£9,800', urgency: 'Spring install window open', source: 'Verified energy signals' } },
  ...
  { id: 'heat-pumps', label: 'Heat Pumps', signals: 'F/G-rated properties, Boiler Upgrade Scheme signals, social housing decarbonisation tenders — detected before Bark or any lead platform lists them', value: '£8k - £18k', example: { title: 'Air source heat pump — F-rated terrace', area: 'NG1 / Nottingham', value: '£12,500', urgency: 'BUS grant window open', source: 'Verified energy signals' } },
  { id: 'decorating', label: 'Decorating', signals: 'Planning-approved renovations, tenancy turnaround contracts, commercial premises redecoration tenders — sourced before any job board lists them', value: '£500 - £20k', example: { title: 'Commercial premises redecoration', area: 'M1 / Manchester', value: '£8,500', urgency: 'Pre-opening deadline', source: 'Official tender record' } },
  ...
  { id: 'data-cabling', label: 'Data Cabling', signals: 'Commercial office fit-out tenders, school and NHS structured cabling contracts, business park signups — scanned 3–5 days before any trade directory sees them', value: '£2k - £30k', example: { title: 'Cat6A structured cabling — office fit-out', area: 'EC2 / London', value: '£18,500', urgency: 'Tenant move-in date', source: 'Verified tender record' } },
