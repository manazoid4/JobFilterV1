      ...
      <section className="jf-box bg-white p-6">
        ...
        <div className="mt-5 grid gap-4 md:grid-cols-3">
          {[
            ...
            ['Your patch. Your timing.', 'Gold leads land in your dashboard the moment they\'re confirmed — one tap sends to WhatsApp. No five-trade blast, no shared auction. Pilot patches are limited — one trade per area, qualification checked.'],
          ].map(([title, body]) => (
