...
const comparison = [
  ...
  { feature: 'Energy upgrade signals', ratedpeople: 'No', jobfilter: 'Yes — retrofit demand mapped from energy signal data', jf: true },
          ...
          <div className="mt-6 grid gap-4 sm:grid-cols-2">
            ...
            <div className="jf-box bg-[var(--navy)] p-5 text-white">
              ...
              <ul className="mt-3 space-y-2 font-black text-sm text-white">
                <li>• Planning approvals, council tenders, ownership data, energy signals</li>
