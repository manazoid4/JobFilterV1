...
const content = {
  ...
  vicinity: {
    ...
    note: 'Built on the same scans that power JobFilter — we know which homes need work before they post a job.',
    distinct: 'Vicinity fills your week between big jobs. Targeted, cheap as chips, no shared auction.',
