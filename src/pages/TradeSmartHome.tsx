...
const data: TradePageData = {
  ...
  painPoints: [
    ...
    ['Comparison sites undervalue your work', 'Smart home automation is a premium service. Comparison sites commoditise it. The high-value clients you want don\'t come from Bark.com — they come from being in front of the right project at the right moment.'],
  ],
  stats: [
...
Action: Open notice → jobfilter.uk/leads/smt856`,
  comparisonOld: [
    ...
    'Comparison sites commoditise smart home work and attract wrong-budget clients',
