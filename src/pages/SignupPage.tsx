  ...
  return (
    <main className="page-shell grid gap-6 py-10">
      <section className="ops-panel bg-[var(--ink)] p-8 text-white">
        <p className="micro-label text-[var(--yellow)]">{planLabel.toUpperCase()} — NO CONTRACT</p>
        <h1 className="headline mt-3 text-5xl leading-none text-white md:text-7xl">TWO MINUTES. YOUR PATCH. YOUR LEADS.</h1>
        <p className="mt-4 max-w-2xl text-xl font-bold text-white/80">
          Fill in your trade and postcode below. Your first public-tender scan covers your area from day one — no shared auction, no five-trade blast. Results vary by what buyers are publishing.
        </p>
      </section>
