  ...
  if (!ready) {
    return (
      <main className="page-shell py-16">
        <section aria-busy="true" className="jf-box max-w-md mx-auto bg-white p-8 text-center">
          <p role="status" aria-live="polite" className="font-black text-[var(--muted)]">Verifying reset link...</p>
    ...
    <main className="page-shell py-16">
      <section className="jf-box max-w-md mx-auto bg-white p-8">
        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-4" aria-busy={loading}>
          <div>
            <label htmlFor="new-password" className="block text-sm font-black uppercase mb-1">New password</label>
            <input
          ...
          <div>
            <label htmlFor="confirm-password" className="block text-sm font-black uppercase mb-1">Confirm password</label>
            <input
          ...
          {error && <p id="password-error" role="alert" aria-live="assertive" className="text-sm font-bold text-[var(--orange)]">{error}</p>}
