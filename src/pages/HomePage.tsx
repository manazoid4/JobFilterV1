        ...
        <div className="page-shell relative grid gap-8 py-10 md:py-14 lg:grid-cols-[1fr_420px] lg:items-end">
          <div>
            ...
            <p className="mt-5 max-w-2xl text-xl font-black leading-tight text-white/90 md:text-2xl">
              JobFilter reads current official notices and tells you BID, WATCH, SUBCONTRACT or SKIP — before you waste a day pricing a tender that doesn't fit your trade or region. Free to scan. No card required.
            </p>
      ...
      <section className="border-y-4 border-[var(--line)] bg-[var(--bg-main)]">
        <div className="page-shell py-14">
          ...
          <div className="mt-8 grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
            {[
              { icon: ShieldCheck, title: 'Your trade. Your patch.', body: 'Scan by trade and delivery area — trade-matched notices ranked first, with broader results shown when your trade has no exact matches.' },
