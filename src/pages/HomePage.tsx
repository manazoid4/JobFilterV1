        ...
        <div className="page-shell relative grid gap-8 py-10 md:py-14 lg:grid-cols-[1fr_420px] lg:items-end">
          <div>
            ...
            <p className="mt-5 max-w-2xl text-xl font-black leading-tight text-white/90 md:text-2xl">
              Stop spending hours on tenders that don't fit your firm. JobFilter checks each public opportunity against your trade, region and contract size — then tells you BID, WATCH, SUBCONTRACT or SKIP.
            </p>
