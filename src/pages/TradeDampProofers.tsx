...
const data: TradePageData = {
  ...
  stats: [
    ...
    ['400+', 'Councils scanned for planning, EPC, and transaction signals'],
    ['1 in 5', 'UK homes has some form of damp or moisture issue'],
  ],
  signals: [
    ['EPC moisture signals', 'Properties with EPC flags for ventilation, moisture, or condensation issues are prime damp treatment candidates. Cross-referenced with property age, construction type, and location to identify high-probability leads.'],
  ...
  howItWorks: [
    ['01', 'Enter your postcode', 'Tell us where you work. We scan EPC data, basement conversion planning, and pre-war property transaction signals within your working radius.'],
    ['02', 'Damp signals get scored', 'EPC moisture flags, basement planning approvals, flood zone planning conditions — each scored by job value, property type, and how urgent the treatment need is likely to be.'],
    ['03', 'Gold leads fire to WhatsApp', 'A Victorian terrace cluster in your area with EPC moisture flags is 12 potential damp treatment jobs worth £800-£4,000 each. You get the alert before the homeowners start calling around.'],
  ],
  tradeLeadExample: {
    ...
    rows: [
      ...
      ['Urgency', 'EPC survey data updated — cluster identified this week'],
      ['Signal type', 'Verified EPC signal — 87% confidence'],
      ['Signal', 'Pre-1900 terrace cluster, EPC surveys flagging moisture and ventilation issues across 12 adjacent properties'],
    ],
...
Area: M14 / Manchester South
Value: £800-£4,000 per property — 12 properties flagged
Urgency: EPC cluster identified this week
...
Action: Open notice → jobfilter.uk/lead/dmp519`,
  comparisonOld: [
    ...
    'Pre-war property damp demand invisible — no one is cross-referencing EPC data',
  ...
  comparisonNew: [
    '£39/month founder — all damp signals, unlimited EPC and planning scans',
    'EPC moisture flags cross-referenced with property age to find cluster leads',
  ...
  metaDescription: 'JobFilter scans EPC data and planning applications across 400+ councils for damp treatment opportunities. Pre-war property clusters, basement conversions, flood zones — Gold leads sent to WhatsApp. Free scan.',
};
